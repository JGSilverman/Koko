using Koko.Server.DataAccess;
using Koko.Server.Domain;
using Koko.Server.Helpers;
...
{
    c.SwaggerDoc("v1", new OpenApiInfo { Title = "Koko", Version = "v1" });
...
app.UseSwaggerUI(c =>
{
    c.SwaggerEndpoint("/swagger/v1/swagger.json", "Koko V1");
});
